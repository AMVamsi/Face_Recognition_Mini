...
Manish_image = face_recognition.load_image_file("./images/Manish.jpg")
Manish_face_encoding = face_recognition.face_encodings(Manish_image)[0]
Maddy_image = face_recognition.load_image_file("./images/Maddy.jpg")
Maddy_face_encoding = face_recognition.face_encodings(Maddy_image)[0]
Niteesh_image = face_recognition.load_image_file("./images/Niteesh.jpg")
...
Vamsi_image = face_recognition.load_image_file("./images/Vamsi.jpg")
